...
function playSound(type) {
    ...
    if (type === 'hover') {
        ...
        gain.gain.setValueAtTime(0.05, now); gain.gain.setValueAtTime(0.05, now + 0.24); 
        ...
        osc.connect(gain); gain.connect(audioCtx.destination);
        osc.type = 'square';
        [261.63, 329.63, 392.00, 523.25].forEach((freq, i) => { osc.frequency.setValueAtTime(freq, now + i*0.15); });
        gain.gain.setValueAtTime(0.1, now); gain.gain.setValueAtTime(0.1, now + 0.6);
